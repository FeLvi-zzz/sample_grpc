...
const (
	Hello_StreamHello_FullMethodName = "/Hello/streamHello"
...
type HelloClient interface {
	StreamHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Hello_StreamHelloClient, error)
...
func (c *helloClient) StreamHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Hello_StreamHelloClient, error) {
	stream, err := c.cc.NewStream(ctx, &Hello_ServiceDesc.Streams[0], Hello_StreamHello_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (x *helloStreamHelloClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
...
type HelloServer interface {
	StreamHello(*HelloRequest, Hello_StreamHelloServer) error
...
func (UnimplementedHelloServer) StreamHello(*HelloRequest, Hello_StreamHelloServer) error {
...
func _Hello_StreamHello_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(HelloServer).StreamHello(m, &helloStreamHelloServer{stream})
}
...
func (x *helloStreamHelloServer) Send(m *HelloResponse) error {
